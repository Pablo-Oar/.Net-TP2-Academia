...
{//test
    public partial class Docentes : System.Web.UI.Page
    {
        ...
        private void LoadForm(int id)
        {
            ...
            this.fehcaNacCalendar.SelectedDate = this.Entity.FechaNacimiento;
        ...
        private void LoadEntity(Personas alumno)
        {
            ...
            alumno.FechaNacimiento = this.fehcaNacCalendar.SelectedDate;
        ...
        private void EnableForm(bool enable)
        {
            ...
            this.fehcaNacCalendar.Enabled = enable;
        }
        ...
        private void ClearForm()
        {
            ...
            this.fehcaNacCalendar.SelectedDate =DateTime.Now;
        }
