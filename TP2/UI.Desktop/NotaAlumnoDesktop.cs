...
{
    public partial class NotaAlumnoDesktop : ApplicationForm
    {
        public NotaAlumnoDesktop()
        {
            InitializeComponent();
        }
        ...
        public NotaAlumnoDesktop(ModoForm modo) : this()
        {
            this.Modo = modo;
        }

        public NotaAlumnoDesktop(int ID, ModoForm modo) : this()
        {
            this.Modo = modo;
